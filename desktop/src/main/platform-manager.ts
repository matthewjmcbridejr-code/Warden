...
export class PlatformManager {
  ...
  hide(): void { for (const id of [...this.activeIds]) this.detach(id); for (const view of this.views.values()) { try { this.window.contentView.removeChildView(view); } catch { /* ignore */ } } this.activeIds = []; }
