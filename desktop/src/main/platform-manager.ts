...
export class PlatformManager {
  ...
  private secureContents(platformId: string, web: Electron.WebContents, kind: ContentsKind): void {
    ...
    web.setWindowOpenHandler(({ url }) => {
      ...
      return { action: 'allow', overrideBrowserWindowOptions: { parent: this.window, show: true, autoHideMenuBar: true, width: 720, height: 820, minWidth: 480, minHeight: 540, backgroundColor: '#0d100e', webPreferences: popupWebPreferences(partition) } };
    });
